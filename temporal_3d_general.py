...
def create_vae(input_shape):
    ...
    enc1_conv = Conv3D(16, (3, 3, 3), strides=(2, 2, 2), padding='same', kernel_regularizer=regularizers.l2(reg_weights))(input)
    enc1_bn_relu = bn_relu()(enc1_conv)
    
    enc2_conv = Conv3D(32, (3, 3, 3), strides=(1, 1, 1), padding='same', kernel_regularizer=regularizers.l2(reg_weights))(enc1_bn_relu)
    enc2_bn_relu = bn_relu()(enc2_conv)
    
    enc3_conv = Conv3D(64, (3, 3, 3), strides=(2, 2, 2), padding='same', kernel_regularizer=regularizers.l2(reg_weights))(enc2_bn_relu)
    enc3_bn_relu = bn_relu()(enc3_conv)
    
    enc4_conv = Conv3D(64, (3, 3, 3), strides=(1, 1, 1), padding='same', kernel_regularizer=regularizers.l2(reg_weights))(enc3_bn_relu)
    enc4_bn_relu = bn_relu()(enc4_conv)
    
    enc5_conv = Conv3D(128, (3, 3, 3), strides=(2, 2, 2), padding='same', kernel_regularizer=regularizers.l2(reg_weights))(enc4_bn_relu)
    enc5_bn_relu = bn_relu()(enc5_conv)
    
    enc6_conv = Conv3D(128, (3, 3, 3), strides=(1, 1, 1), padding='same', kernel_regularizer=regularizers.l2(reg_weights))(enc5_bn_relu)
    enc6_bn_relu = bn_relu()(enc6_conv)


    x0 = res_conv(128, 3, 3, 3)(enc6_bn_relu)
    x1 = res_conv(128, 3, 3, 3)(x0)
    x2 = res_conv(128, 3, 3, 3)(x1)
    x3 = res_conv(128, 3, 3, 3)(x2)
    x4 = res_conv(128, 3, 3, 3)(x3)
    x5 = res_conv(128, 3, 3, 3)(x4)
    dec6 = res_conv(128, 3, 3, 3)(x5)

    dec5 = dconv_bn_nolinear(128, 3, 3, 3, stride=(1, 1, 1))(dec6)
    dec4 = dconv_bn_nolinear(128, 3, 3, 3, stride=(2, 2, 2))(dec5)
    dec3 = dconv_bn_nolinear(64, 3, 3, 3, stride=(1, 1, 1))(dec4)
    dec2 = dconv_bn_nolinear(64, 3, 3, 3, stride=(2, 2, 2))(dec3)
    dec1 = dconv_bn_nolinear(32, 3, 3, 3, stride=(1, 1, 1))(dec2)
    dec0 = dconv_bn_nolinear(16, 3, 3, 3, stride=(2, 2, 2))(dec1)
